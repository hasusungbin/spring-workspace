...
<jsp:include page="/WEB-INF/views/common/header.jsp" />
   ...
   <script>
   	const userNo = '${loginUser.userNo}'; // session scope 안에있는 userNo
   	const userId = '${loginUser.userId}';
   	const nickName = '${loginUser.nickName}';
   	const chatRoomNo = '${chatRoomNo}';
   	const contextPath = '${contextPath}';
   	
   	// /chat 이라는 요청주소로 통신할 수 있는 WebSocket객체 생성
   	let chattingSock = new SockJS(contextPath+"/chat");
   	// webSocket 프로토콜을 이용해서 해당 주소로 데이터를 송/수진 할 수 있음.

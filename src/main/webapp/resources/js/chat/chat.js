 ...
 */
 ...
 function sendMessage(){
 	...
 	// 메세지 입력 시 필요한 데이터를 js객체로 생성
 		...
 		// JSON.stringify(객체) : JS Object -> JSON (JSON -> 문자열 , Object -> 객체 : 객체 -> 문자열로 바꿔줌)
 ...
 // 웹소켓 핸들러에서 sendMessage라는 함수가 호출되었을 때 캐치하는 이벤트핸들러
 
 chattingSock.onmessage = function(e){
 	// 매개변수인 e : 발생한 이벤트에 대한 정보를 담고있는 객체.
 	// e.data : 전달 된 메세지를 담고있음.(JSON객체) == > message.getPayload()
